...
_casadi.SWIG_IND1_swigconstant(_casadi)
...
_casadi.OP_ASSIGN_swigconstant(_casadi)
OP_ASSIGN = _casadi.OP_ASSIGN

_casadi.OP_ADD_swigconstant(_casadi)
OP_ADD = _casadi.OP_ADD

_casadi.OP_SUB_swigconstant(_casadi)
OP_SUB = _casadi.OP_SUB

_casadi.OP_MUL_swigconstant(_casadi)
OP_MUL = _casadi.OP_MUL

_casadi.OP_DIV_swigconstant(_casadi)
OP_DIV = _casadi.OP_DIV

_casadi.OP_NEG_swigconstant(_casadi)
OP_NEG = _casadi.OP_NEG

_casadi.OP_EXP_swigconstant(_casadi)
OP_EXP = _casadi.OP_EXP

_casadi.OP_LOG_swigconstant(_casadi)
OP_LOG = _casadi.OP_LOG

_casadi.OP_POW_swigconstant(_casadi)
OP_POW = _casadi.OP_POW

_casadi.OP_CONSTPOW_swigconstant(_casadi)
OP_CONSTPOW = _casadi.OP_CONSTPOW

_casadi.OP_SQRT_swigconstant(_casadi)
OP_SQRT = _casadi.OP_SQRT

_casadi.OP_SQ_swigconstant(_casadi)
OP_SQ = _casadi.OP_SQ

_casadi.OP_TWICE_swigconstant(_casadi)
OP_TWICE = _casadi.OP_TWICE

_casadi.OP_SIN_swigconstant(_casadi)
OP_SIN = _casadi.OP_SIN

_casadi.OP_COS_swigconstant(_casadi)
OP_COS = _casadi.OP_COS

_casadi.OP_TAN_swigconstant(_casadi)
OP_TAN = _casadi.OP_TAN

_casadi.OP_ASIN_swigconstant(_casadi)
OP_ASIN = _casadi.OP_ASIN

_casadi.OP_ACOS_swigconstant(_casadi)
OP_ACOS = _casadi.OP_ACOS

_casadi.OP_ATAN_swigconstant(_casadi)
OP_ATAN = _casadi.OP_ATAN

_casadi.OP_LT_swigconstant(_casadi)
OP_LT = _casadi.OP_LT

_casadi.OP_LE_swigconstant(_casadi)
OP_LE = _casadi.OP_LE

_casadi.OP_EQ_swigconstant(_casadi)
OP_EQ = _casadi.OP_EQ

_casadi.OP_NE_swigconstant(_casadi)
OP_NE = _casadi.OP_NE

_casadi.OP_NOT_swigconstant(_casadi)
OP_NOT = _casadi.OP_NOT

_casadi.OP_AND_swigconstant(_casadi)
OP_AND = _casadi.OP_AND

_casadi.OP_OR_swigconstant(_casadi)
OP_OR = _casadi.OP_OR

_casadi.OP_FLOOR_swigconstant(_casadi)
OP_FLOOR = _casadi.OP_FLOOR

_casadi.OP_CEIL_swigconstant(_casadi)
OP_CEIL = _casadi.OP_CEIL

_casadi.OP_FMOD_swigconstant(_casadi)
OP_FMOD = _casadi.OP_FMOD

_casadi.OP_FABS_swigconstant(_casadi)
OP_FABS = _casadi.OP_FABS

_casadi.OP_SIGN_swigconstant(_casadi)
OP_SIGN = _casadi.OP_SIGN

_casadi.OP_COPYSIGN_swigconstant(_casadi)
OP_COPYSIGN = _casadi.OP_COPYSIGN

_casadi.OP_IF_ELSE_ZERO_swigconstant(_casadi)
OP_IF_ELSE_ZERO = _casadi.OP_IF_ELSE_ZERO

_casadi.OP_ERF_swigconstant(_casadi)
OP_ERF = _casadi.OP_ERF

_casadi.OP_FMIN_swigconstant(_casadi)
OP_FMIN = _casadi.OP_FMIN

_casadi.OP_FMAX_swigconstant(_casadi)
OP_FMAX = _casadi.OP_FMAX

_casadi.OP_INV_swigconstant(_casadi)
OP_INV = _casadi.OP_INV

_casadi.OP_SINH_swigconstant(_casadi)
OP_SINH = _casadi.OP_SINH

_casadi.OP_COSH_swigconstant(_casadi)
OP_COSH = _casadi.OP_COSH

_casadi.OP_TANH_swigconstant(_casadi)
OP_TANH = _casadi.OP_TANH

_casadi.OP_ASINH_swigconstant(_casadi)
OP_ASINH = _casadi.OP_ASINH

_casadi.OP_ACOSH_swigconstant(_casadi)
OP_ACOSH = _casadi.OP_ACOSH

_casadi.OP_ATANH_swigconstant(_casadi)
OP_ATANH = _casadi.OP_ATANH

_casadi.OP_ATAN2_swigconstant(_casadi)
OP_ATAN2 = _casadi.OP_ATAN2

_casadi.OP_CONST_swigconstant(_casadi)
OP_CONST = _casadi.OP_CONST

_casadi.OP_INPUT_swigconstant(_casadi)
OP_INPUT = _casadi.OP_INPUT

_casadi.OP_OUTPUT_swigconstant(_casadi)
OP_OUTPUT = _casadi.OP_OUTPUT

_casadi.OP_PARAMETER_swigconstant(_casadi)
OP_PARAMETER = _casadi.OP_PARAMETER

_casadi.OP_CALL_swigconstant(_casadi)
OP_CALL = _casadi.OP_CALL

_casadi.OP_FIND_swigconstant(_casadi)
OP_FIND = _casadi.OP_FIND

_casadi.OP_MAP_swigconstant(_casadi)
OP_MAP = _casadi.OP_MAP

_casadi.OP_MTIMES_swigconstant(_casadi)
OP_MTIMES = _casadi.OP_MTIMES

_casadi.OP_SOLVE_swigconstant(_casadi)
OP_SOLVE = _casadi.OP_SOLVE

_casadi.OP_TRANSPOSE_swigconstant(_casadi)
OP_TRANSPOSE = _casadi.OP_TRANSPOSE

_casadi.OP_DETERMINANT_swigconstant(_casadi)
OP_DETERMINANT = _casadi.OP_DETERMINANT

_casadi.OP_INVERSE_swigconstant(_casadi)
OP_INVERSE = _casadi.OP_INVERSE

_casadi.OP_DOT_swigconstant(_casadi)
OP_DOT = _casadi.OP_DOT

_casadi.OP_BILIN_swigconstant(_casadi)
OP_BILIN = _casadi.OP_BILIN

_casadi.OP_RANK1_swigconstant(_casadi)
OP_RANK1 = _casadi.OP_RANK1

_casadi.OP_HORZCAT_swigconstant(_casadi)
OP_HORZCAT = _casadi.OP_HORZCAT

_casadi.OP_VERTCAT_swigconstant(_casadi)
OP_VERTCAT = _casadi.OP_VERTCAT

_casadi.OP_DIAGCAT_swigconstant(_casadi)
OP_DIAGCAT = _casadi.OP_DIAGCAT

_casadi.OP_HORZSPLIT_swigconstant(_casadi)
OP_HORZSPLIT = _casadi.OP_HORZSPLIT

_casadi.OP_VERTSPLIT_swigconstant(_casadi)
OP_VERTSPLIT = _casadi.OP_VERTSPLIT

_casadi.OP_DIAGSPLIT_swigconstant(_casadi)
OP_DIAGSPLIT = _casadi.OP_DIAGSPLIT

_casadi.OP_RESHAPE_swigconstant(_casadi)
OP_RESHAPE = _casadi.OP_RESHAPE

_casadi.OP_SUBREF_swigconstant(_casadi)
OP_SUBREF = _casadi.OP_SUBREF

_casadi.OP_SUBASSIGN_swigconstant(_casadi)
OP_SUBASSIGN = _casadi.OP_SUBASSIGN

_casadi.OP_GETNONZEROS_swigconstant(_casadi)
OP_GETNONZEROS = _casadi.OP_GETNONZEROS

_casadi.OP_ADDNONZEROS_swigconstant(_casadi)
OP_ADDNONZEROS = _casadi.OP_ADDNONZEROS

_casadi.OP_SETNONZEROS_swigconstant(_casadi)
OP_SETNONZEROS = _casadi.OP_SETNONZEROS

_casadi.OP_PROJECT_swigconstant(_casadi)
OP_PROJECT = _casadi.OP_PROJECT

_casadi.OP_ASSERTION_swigconstant(_casadi)
OP_ASSERTION = _casadi.OP_ASSERTION

_casadi.OP_MONITOR_swigconstant(_casadi)
OP_MONITOR = _casadi.OP_MONITOR

_casadi.OP_NORM2_swigconstant(_casadi)
OP_NORM2 = _casadi.OP_NORM2

_casadi.OP_NORM1_swigconstant(_casadi)
OP_NORM1 = _casadi.OP_NORM1

_casadi.OP_NORMINF_swigconstant(_casadi)
OP_NORMINF = _casadi.OP_NORMINF

_casadi.OP_NORMF_swigconstant(_casadi)
OP_NORMF = _casadi.OP_NORMF

_casadi.OP_HORZREPMAT_swigconstant(_casadi)
OP_HORZREPMAT = _casadi.OP_HORZREPMAT

_casadi.OP_HORZREPSUM_swigconstant(_casadi)
OP_HORZREPSUM = _casadi.OP_HORZREPSUM

_casadi.OP_ERFINV_swigconstant(_casadi)
OP_ERFINV = _casadi.OP_ERFINV

_casadi.OP_PRINTME_swigconstant(_casadi)
OP_PRINTME = _casadi.OP_PRINTME

_casadi.OP_LIFT_swigconstant(_casadi)
...
class Sparsity(SharedObject, SpSparsity):
    ...
    def rowcol(*args):
        """rowcol(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, int nrow, int ncol) -> Sparsity"""
    ...
    def triplet(*args):
        """
        triplet(int nrow, int ncol, std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, std::vector< int,std::allocator< int > > & mapping, bool invert_mapping=False) -> Sparsity
    ...
    def sub(self, *args):
        """
        sub(Sparsity self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False) -> Sparsity
    ...
    def enlarge(self, *args):
        """
        enlarge(Sparsity self, int nrow, int ncol, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def erase(self, *args):
        """
        erase(Sparsity self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False) -> std::vector< int,std::allocator< int > >
    ...
    def dfs(self, *args):
        """
        dfs(Sparsity self, int j, int top, std::vector< int,std::allocator< int > > & xi, std::vector< int,std::allocator< int > > & pstack, std::vector< int,std::allocator< int > > const & pinv, std::vector< bool,std::allocator< bool > > & marked) -> int
    ...
    def uni_coloring(self, *args):
        """
        uni_coloring(Sparsity self, Sparsity AT, int cutoff) -> Sparsity
    ...
    def star_coloring(self, *args):
        """
        star_coloring(Sparsity self, int ordering=1, int cutoff) -> Sparsity
    ...
    def star_coloring2(self, *args):
        """
        star_coloring2(Sparsity self, int ordering=1, int cutoff) -> Sparsity
    ...
    def pmult(self, *args):
        """
        pmult(Sparsity self, std::vector< int,std::allocator< int > > const & p, bool permute_rows=True, bool permute_columns=True, bool invert_permutation=False) -> Sparsity
...
def Sparsity_rowcol(*args):
    """Sparsity_rowcol(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, int nrow, int ncol) -> Sparsity"""
    return _casadi.Sparsity_rowcol(*args)
...
_casadi.IS_GLOBAL_swigconstant(_casadi)
IS_GLOBAL = _casadi.IS_GLOBAL

_casadi.IS_MEMBER_swigconstant(_casadi)
IS_MEMBER = _casadi.IS_MEMBER

_casadi.IS_SPARSITY_swigconstant(_casadi)
IS_SPARSITY = _casadi.IS_SPARSITY

_casadi.IS_DMATRIX_swigconstant(_casadi)
IS_DMATRIX = _casadi.IS_DMATRIX

_casadi.IS_IMATRIX_swigconstant(_casadi)
IS_IMATRIX = _casadi.IS_IMATRIX

_casadi.IS_SX_swigconstant(_casadi)
IS_SX = _casadi.IS_SX

_casadi.IS_MX_swigconstant(_casadi)
IS_MX = _casadi.IS_MX

_casadi.IS_DOUBLE_swigconstant(_casadi)
...
class DM(MatrixCommon, ExpDM, GenDM, PrintDM):
    ...
    def jac(*args):
        ...
        jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> DM
    ...
    def erase(self, *args):
        """
        erase(DM self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def enlarge(self, *args):
        """
        enlarge(DM self, int nrow, int ncol, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def triplet(*args):
        """
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d) -> DM
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d, int nrow, int ncol) -> DM
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d, std::pair< int,int > const & rc) -> DM
        """
...
def DM_jac(*args):
    ...
    jac(Function f, std::string const & iname, int oind=0, bool compact=False, bool symmetric=False) -> DM
    jac(Function f, int iind, std::string const & oname, bool compact=False, bool symmetric=False) -> DM
    DM_jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> DM
...
def DM_triplet(*args):
    ...
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d) -> DM
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d, int nrow, int ncol) -> DM
    DM_triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, DM d, std::pair< int,int > const & rc) -> DM
    """
    return _casadi.DM_triplet(*args)
...
class IM(MatrixCommon, ExpIM, GenIM, PrintIM):
    ...
    def jac(*args):
        ...
        jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> IM
    ...
    def erase(self, *args):
        """
        erase(IM self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def enlarge(self, *args):
        """
        enlarge(IM self, int nrow, int ncol, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def triplet(*args):
        """
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d) -> IM
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d, int nrow, int ncol) -> IM
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d, std::pair< int,int > const & rc) -> IM
        """
...
def IM_jac(*args):
    ...
    jac(Function f, std::string const & iname, int oind=0, bool compact=False, bool symmetric=False) -> IM
    jac(Function f, int iind, std::string const & oname, bool compact=False, bool symmetric=False) -> IM
    IM_jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> IM
...
def IM_triplet(*args):
    ...
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d) -> IM
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d, int nrow, int ncol) -> IM
    IM_triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, IM d, std::pair< int,int > const & rc) -> IM
    """
    return _casadi.IM_triplet(*args)
...
class SX(MatrixCommon, ExpSX, GenSX, PrintSX):
    ...
    def jac(*args):
        ...
        jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> SX
    ...
    def erase(self, *args):
        """
        erase(SX self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def enlarge(self, *args):
        """
        enlarge(SX self, int nrow, int ncol, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def triplet(*args):
        """
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d) -> SX
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d, int nrow, int ncol) -> SX
        triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d, std::pair< int,int > const & rc) -> SX
        """
...
def SX_jac(*args):
    ...
    jac(Function f, std::string const & iname, int oind=0, bool compact=False, bool symmetric=False) -> SX
    jac(Function f, int iind, std::string const & oname, bool compact=False, bool symmetric=False) -> SX
    SX_jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> SX
...
def SX_triplet(*args):
    ...
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d) -> SX
    triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d, int nrow, int ncol) -> SX
    SX_triplet(std::vector< int,std::allocator< int > > const & row, std::vector< int,std::allocator< int > > const & col, SX d, std::pair< int,int > const & rc) -> SX
    """
    return _casadi.SX_triplet(*args)
...
class MX(ExpMX, GenMX, SharedObject):
    ...
    def erase(self, *args):
        """
        erase(MX self, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def enlarge(self, *args):
        """
        enlarge(MX self, int nrow, int ncol, std::vector< int,std::allocator< int > > const & rr, std::vector< int,std::allocator< int > > const & cc, bool ind1=False)
    ...
    def jac(*args):
        ...
        jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> MX
...
def MX_jac(*args):
    ...
    jac(Function f, std::string const & iname, int oind=0, bool compact=False, bool symmetric=False) -> MX
    jac(Function f, int iind, std::string const & oname, bool compact=False, bool symmetric=False) -> MX
    MX_jac(Function f, std::string const & iname, std::string const & oname, bool compact=False, bool symmetric=False) -> MX
...
class Function(SharedObject):
    ...
    def expand(self, *args):
        ...
        expand(Function self, std::string const & name, casadi::Dict const & opts) -> Function
    ...
    def mapsum(self, *args):
        """
        mapsum(Function self, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::string const & parallelization) -> std::vector< casadi::MX,std::allocator< casadi::MX > >
    ...
    def mapaccum(self, *args):
        """
        mapaccum(Function self, std::string const & name, int n, casadi::Dict const & opts) -> Function
        mapaccum(Function self, std::string const & name, int n, std::vector< int,std::allocator< int > > const & accum_in, std::vector< int,std::allocator< int > > const & accum_out, casadi::Dict const & opts) -> Function
    ...
    def map(self, *args):
        """
        map(Function self, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::string const & parallelization) -> std::vector< casadi::MX,std::allocator< casadi::MX > >
        map(Function self, std::map< std::string,casadi::MX,std::less< std::string >,std::allocator< std::pair< std::string const,casadi::MX > > > const & arg, std::string const & parallelization) -> std::map< std::string,casadi::MX,std::less< std::string >,std::allocator< std::pair< std::string const,casadi::MX > > >
        map(Function self, std::string const & name, std::string const & parallelization, int n, std::vector< int,std::allocator< int > > const & reduce_in, std::vector< int,std::allocator< int > > const & reduce_out, casadi::Dict const & opts) -> Function
        map(Function self, std::string const & name, std::string const & parallelization, int n, casadi::Dict const & opts) -> Function
    ...
    def slice(self, *args):
        """
        slice(Function self, std::vector< int,std::allocator< int > > const & order_in, std::vector< int,std::allocator< int > > const & order_out, casadi::Dict const & opts) -> Function
    ...
    def conditional(*args):
        """conditional(std::string const & name, std::vector< casadi::Function,std::allocator< casadi::Function > > const & f, Function f_def, casadi::Dict const & opts) -> Function"""
    ...
    def if_else(*args):
        """if_else(std::string const & name, Function f_true, Function f_false, casadi::Dict const & opts) -> Function"""
    ...
    def kernel_sum(self, *args):
        """
        kernel_sum(Function self, std::string const & name, std::pair< int,int > const & size, double r, int n, casadi::Dict const & opts) -> Function
    ...
    def derivative(self, *args):
        """
        derivative(Function self, casadi::DMVector const & arg, casadi::DMVectorVector const & fseed, casadi::DMVectorVector const & aseed, bool always_inline=False, bool never_inline=False)
        derivative(Function self, casadi::SXVector const & arg, casadi::SXVectorVector const & fseed, casadi::SXVectorVector const & aseed, bool always_inline=False, bool never_inline=False)
        derivative(Function self, casadi::MXVector const & arg, casadi::MXVectorVector const & fseed, casadi::MXVectorVector const & aseed, bool always_inline=False, bool never_inline=False)
    ...
    def forward(self, *args):
        """
        forward(Function self, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::vector< casadi::MX,std::allocator< casadi::MX > > const & res, std::vector< std::vector< casadi::MX,std::allocator< casadi::MX > >,std::allocator< std::vector< casadi::MX,std::allocator< casadi::MX > > > > const & fseed, bool always_inline=False, bool never_inline=False)
        forward(Function self, std::vector< casadi::SX,std::allocator< casadi::SX > > const & arg, std::vector< casadi::SX,std::allocator< casadi::SX > > const & res, std::vector< std::vector< casadi::SX,std::allocator< casadi::SX > >,std::allocator< std::vector< casadi::SX,std::allocator< casadi::SX > > > > const & fseed, bool always_inline=False, bool never_inline=False)
        forward(Function self, std::vector< casadi::DM,std::allocator< casadi::DM > > const & arg, std::vector< casadi::DM,std::allocator< casadi::DM > > const & res, std::vector< std::vector< casadi::DM,std::allocator< casadi::DM > >,std::allocator< std::vector< casadi::DM,std::allocator< casadi::DM > > > > const & fseed, bool always_inline=False, bool never_inline=False)
    ...
    def reverse(self, *args):
        """
        reverse(Function self, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::vector< casadi::MX,std::allocator< casadi::MX > > const & res, std::vector< std::vector< casadi::MX,std::allocator< casadi::MX > >,std::allocator< std::vector< casadi::MX,std::allocator< casadi::MX > > > > const & aseed, bool always_inline=False, bool never_inline=False)
        reverse(Function self, std::vector< casadi::SX,std::allocator< casadi::SX > > const & arg, std::vector< casadi::SX,std::allocator< casadi::SX > > const & res, std::vector< std::vector< casadi::SX,std::allocator< casadi::SX > >,std::allocator< std::vector< casadi::SX,std::allocator< casadi::SX > > > > const & aseed, bool always_inline=False, bool never_inline=False)
        reverse(Function self, std::vector< casadi::DM,std::allocator< casadi::DM > > const & arg, std::vector< casadi::DM,std::allocator< casadi::DM > > const & res, std::vector< std::vector< casadi::DM,std::allocator< casadi::DM > >,std::allocator< std::vector< casadi::DM,std::allocator< casadi::DM > > > > const & aseed, bool always_inline=False, bool never_inline=False)
    ...
    def generate(self, *args):
        """
        generate(Function self, std::string const & fname, casadi::Dict const & opts)
        generate(Function self, casadi::Dict const & opts)
    ...
    def generate_dependencies(self, *args):
        """
        generate_dependencies(Function self, std::string const & fname, casadi::Dict const & opts)
    ...
    def __init__(self, *args):
        ...
        __init__(casadi::Function self, std::string const & name, std::vector< casadi::SX,std::allocator< casadi::SX > > const & arg, std::vector< casadi::SX,std::allocator< casadi::SX > > const & res, casadi::Dict const & opts) -> Function
        __init__(casadi::Function self, std::string const & name, std::vector< casadi::SX,std::allocator< casadi::SX > > const & arg, std::vector< casadi::SX,std::allocator< casadi::SX > > const & res, std::vector< std::string,std::allocator< std::string > > const & argn, std::vector< std::string,std::allocator< std::string > > const & resn, casadi::Dict const & opts) -> Function
        __init__(casadi::Function self, std::string const & name, std::map< std::string,casadi::SX,std::less< std::string >,std::allocator< std::pair< std::string const,casadi::SX > > > const & dict, std::vector< std::string,std::allocator< std::string > > const & argn, std::vector< std::string,std::allocator< std::string > > const & resn, casadi::Dict const & opts) -> Function
        __init__(casadi::Function self, std::string const & name, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::vector< casadi::MX,std::allocator< casadi::MX > > const & res, casadi::Dict const & opts) -> Function
        __init__(casadi::Function self, std::string const & name, std::vector< casadi::MX,std::allocator< casadi::MX > > const & arg, std::vector< casadi::MX,std::allocator< casadi::MX > > const & res, std::vector< std::string,std::allocator< std::string > > const & argn, std::vector< std::string,std::allocator< std::string > > const & resn, casadi::Dict const & opts) -> Function
        __init__(casadi::Function self, std::string const & name, std::map< std::string,casadi::MX,std::less< std::string >,std::allocator< std::pair< std::string const,casadi::MX > > > const & dict, std::vector< std::string,std::allocator< std::string > > const & argn, std::vector< std::string,std::allocator< std::string > > const & resn, casadi::Dict const & opts) -> Function
...
def Function_conditional(*args):
    """Function_conditional(std::string const & name, std::vector< casadi::Function,std::allocator< casadi::Function > > const & f, Function f_def, casadi::Dict const & opts) -> Function"""
    return _casadi.Function_conditional(*args)

def Function_if_else(*args):
    """Function_if_else(std::string const & name, Function f_true, Function f_false, casadi::Dict const & opts) -> Function"""
    return _casadi.Function_if_else(*args)
...
def external(*args):
    """
    external(std::string const & name, casadi::Dict const & opts) -> Function
    external(std::string const & name, std::string const & bin_name, casadi::Dict const & opts) -> Function
    external(std::string const & name, Compiler compiler, casadi::Dict const & opts) -> Function
...
def jit(*args):
    """
    jit(std::string const & name, int n_in, int n_out, std::string const & body, casadi::Dict const & opts) -> Function
...
def integrator(*args):
    """
    integrator(std::string const & name, std::string const & solver, casadi::SXDict const & dae, casadi::Dict const & opts) -> Function
    integrator(std::string const & name, std::string const & solver, casadi::MXDict const & dae, casadi::Dict const & opts) -> Function
    integrator(std::string const & name, std::string const & solver, Function dae, casadi::Dict const & opts) -> Function
    integrator(std::string const & name, std::string const & solver, std::pair< casadi::Function,casadi::Function > const & dae, casadi::Dict const & opts) -> Function
...
def qpsol(*args):
    """
    qpsol(std::string const & name, std::string const & solver, casadi::SpDict const & qp, casadi::Dict const & opts) -> Function
    qpsol(std::string const & name, std::string const & solver, casadi::SXDict const & qp, casadi::Dict const & opts) -> Function
    qpsol(std::string const & name, std::string const & solver, casadi::MXDict const & qp, casadi::Dict const & opts) -> Function
...
def nlpsol(*args):
    """
    nlpsol(std::string const & name, std::string const & solver, casadi::SXDict const & nlp, casadi::Dict const & opts) -> Function
    nlpsol(std::string const & name, std::string const & solver, casadi::MXDict const & nlp, casadi::Dict const & opts) -> Function
    nlpsol(std::string const & name, std::string const & solver, Function nlp, casadi::Dict const & opts) -> Function
    nlpsol(std::string const & name, std::string const & solver, std::string const & fname, casadi::Dict const & opts) -> Function
    nlpsol(std::string const & name, std::string const & solver, Compiler compiler, casadi::Dict const & opts) -> Function
...
def rootfinder(*args):
    """
    rootfinder(std::string const & name, std::string const & solver, Function f, casadi::Dict const & opts) -> Function
...
def linsol(*args):
    """
    linsol(std::string const & name, std::string const & solver, Sparsity sp, int nrhs, casadi::Dict const & opts) -> Function
...
class CodeGenerator(_object):
    ...
    def __init__(self, *args):
        """
        __init__(casadi::CodeGenerator self, casadi::Dict const & opts) -> CodeGenerator
    ...
    def compile(self, *args):
        """
        compile(CodeGenerator self, std::string const & name, std::string const & compiler) -> std::string
    ...
    def addInclude(self, *args):
        """
        addInclude(CodeGenerator self, std::string const & new_include, bool relative_path=False, std::string const & use_ifdef)
...
_casadi.FLAG_swigconstant(_casadi)
FLAG = _casadi.FLAG
...
def offset(*args):
    ...
    offset(std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & v, bool vert=True) -> std::vector< int,std::allocator< int > >
    offset(std::vector< casadi::Matrix< double >,std::allocator< casadi::Matrix< double > > > const & v, bool vert=True) -> std::vector< int,std::allocator< int > >
    offset(std::vector< casadi::Matrix< casadi::SXElem >,std::allocator< casadi::Matrix< casadi::SXElem > > > const & v, bool vert=True) -> std::vector< int,std::allocator< int > >
    """
...
def conditional(*args):
    """
    conditional(MX ind, std::vector< casadi::MX,std::allocator< casadi::MX > > const & x, MX x_default, bool short_circuit=True) -> MX
    conditional(IM ind, std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & x, IM x_default, bool short_circuit=True) -> IM
    conditional(DM ind, std::vector< casadi::Matrix< double >,std::allocator< casadi::Matrix< double > > > const & x, DM x_default, bool short_circuit=True) -> DM
    conditional(SX ind, std::vector< casadi::Matrix< casadi::SXElem >,std::allocator< casadi::Matrix< casadi::SXElem > > > const & x, SX x_default, bool short_circuit=True) -> SX
    """
...
def solve(*args):
    """
    solve(MX A, MX b) -> MX
    solve(MX A, MX b, std::string const & lsolver, casadi::Dict const & opts) -> MX
    solve(IM A, IM b) -> IM
    solve(IM A, IM b, std::string const & lsolver, casadi::Dict const & opts) -> IM
    solve(DM A, DM b) -> DM
    solve(DM A, DM b, std::string const & lsolver, casadi::Dict const & opts) -> DM
    solve(SX A, SX b) -> SX
    solve(SX A, SX b, std::string const & lsolver, casadi::Dict const & opts) -> SX
    """
...
def pinv(*args):
    """
    pinv(MX A) -> MX
    pinv(MX A, std::string const & lsolver, casadi::Dict const & opts) -> MX
    pinv(IM A) -> IM
    pinv(IM A, std::string const & lsolver, casadi::Dict const & opts) -> IM
    pinv(DM A) -> DM
    pinv(DM A, std::string const & lsolver, casadi::Dict const & opts) -> DM
    pinv(SX A) -> SX
    pinv(SX A, std::string const & lsolver, casadi::Dict const & opts) -> SX
    """
...
def substitute(*args):
    ...
    substitute(std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & ex, std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & v, std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & vdef) -> std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > >
...
def substitute_inplace(*args):
    ...
    substitute_inplace(std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & v, std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > & INOUT1, std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > & INOUT2, bool reverse=False)
...
def shared(*args):
    """
    shared(std::vector< casadi::MX,std::allocator< casadi::MX > > const & ex, std::string const & v_prefix, std::string const & v_suffix)
    shared(std::vector< casadi::Matrix< int >,std::allocator< casadi::Matrix< int > > > const & ex, std::string const & v_prefix, std::string const & v_suffix)
    shared(std::vector< casadi::Matrix< double >,std::allocator< casadi::Matrix< double > > > const & ex, std::string const & v_prefix, std::string const & v_suffix)
    shared(std::vector< casadi::Matrix< casadi::SXElem >,std::allocator< casadi::Matrix< casadi::SXElem > > > const & ex, std::string const & v_prefix, std::string const & v_suffix)
    """
...
def matrix_expand(*args):
    """
    matrix_expand(std::vector< casadi::MX,std::allocator< casadi::MX > > const & e, std::vector< casadi::MX,std::allocator< casadi::MX > > const & boundary, casadi::Dict const & options) -> std::vector< casadi::MX,std::allocator< casadi::MX > >
    matrix_expand(MX e, std::vector< casadi::MX,std::allocator< casadi::MX > > const & boundary, casadi::Dict const & options) -> MX
    """
...
class Compiler(SharedObject):
    ...
    def __init__(self, *args):
        ...
        __init__(casadi::Compiler self, std::string const & name, std::string const & compiler, casadi::Dict const & opts) -> Compiler
...
class Callback(Function):
    ...
    def create(*args):
        """create(std::string const & name, Callback n, casadi::Dict const & opts) -> Function"""
    ...
    def construct(self, *args):
        """
        construct(Callback self, std::string const & name, casadi::Dict const & opts)
...
def Callback_create(*args):
    """Callback_create(std::string const & name, Callback n, casadi::Dict const & opts) -> Function"""
    return _casadi.Callback_create(*args)
...
def collocation_points(*args):
    """
    collocation_points(int order, std::string const & scheme) -> std::vector< double,std::allocator< double > >
...
_casadi.LEGENDRE_swigconstant(_casadi)
LEGENDRE = _casadi.LEGENDRE

_casadi.RADAU_swigconstant(_casadi)
RADAU = _casadi.RADAU
...
def simpleIRK(*args):
    """
    simpleIRK(Function f, int N=10, int order=4, std::string const & scheme, std::string const & solver, casadi::Dict const & solver_options) -> Function
...
def simpleIntegrator(*args):
    """
    simpleIntegrator(Function f, std::string const & integrator, casadi::Dict const & integrator_options) -> Function
...
class NlpBuilder(PrintNlpBuilder):
    ...
    def parse_nl(self, *args):
        """
        parse_nl(NlpBuilder self, std::string const & filename, casadi::Dict const & options)
...
_casadi.CONSTANT_swigconstant(_casadi)
CONSTANT = _casadi.CONSTANT

_casadi.PARAMETER_swigconstant(_casadi)
PARAMETER = _casadi.PARAMETER

_casadi.DISCRETE_swigconstant(_casadi)
DISCRETE = _casadi.DISCRETE

_casadi.CONTINUOUS_swigconstant(_casadi)
CONTINUOUS = _casadi.CONTINUOUS

_casadi.INPUT_swigconstant(_casadi)
INPUT = _casadi.INPUT

_casadi.OUTPUT_swigconstant(_casadi)
OUTPUT = _casadi.OUTPUT

_casadi.INTERNAL_swigconstant(_casadi)
INTERNAL = _casadi.INTERNAL

_casadi.ALGEBRAIC_swigconstant(_casadi)
ALGEBRAIC = _casadi.ALGEBRAIC

_casadi.DIFFERENTIAL_swigconstant(_casadi)
DIFFERENTIAL = _casadi.DIFFERENTIAL

_casadi.NO_ALIAS_swigconstant(_casadi)
NO_ALIAS = _casadi.NO_ALIAS

_casadi.ALIAS_swigconstant(_casadi)
ALIAS = _casadi.ALIAS

_casadi.NEGATED_ALIAS_swigconstant(_casadi)
NEGATED_ALIAS = _casadi.NEGATED_ALIAS

_casadi.CAT_UNKNOWN_swigconstant(_casadi)
CAT_UNKNOWN = _casadi.CAT_UNKNOWN

_casadi.CAT_DERIVATIVE_swigconstant(_casadi)
CAT_DERIVATIVE = _casadi.CAT_DERIVATIVE

_casadi.CAT_STATE_swigconstant(_casadi)
CAT_STATE = _casadi.CAT_STATE

_casadi.CAT_DEPENDENT_CONSTANT_swigconstant(_casadi)
CAT_DEPENDENT_CONSTANT = _casadi.CAT_DEPENDENT_CONSTANT

_casadi.CAT_INDEPENDENT_CONSTANT_swigconstant(_casadi)
CAT_INDEPENDENT_CONSTANT = _casadi.CAT_INDEPENDENT_CONSTANT

_casadi.CAT_DEPENDENT_PARAMETER_swigconstant(_casadi)
CAT_DEPENDENT_PARAMETER = _casadi.CAT_DEPENDENT_PARAMETER

_casadi.CAT_INDEPENDENT_PARAMETER_swigconstant(_casadi)
CAT_INDEPENDENT_PARAMETER = _casadi.CAT_INDEPENDENT_PARAMETER

_casadi.CAT_ALGEBRAIC_swigconstant(_casadi)
...
class Variable(PrintVariable):
    ...
    def __init__(self, *args):
        ...
        __init__(casadi::Variable self, std::string const & name, Sparsity sp) -> Variable
...
class DaeBuilder(PrintDaeBuilder):
    ...
    def add_p(self, *args):
        """
        add_p(DaeBuilder self, std::string const & name, int n=1) -> MX
    ...
    def add_u(self, *args):
        """
        add_u(DaeBuilder self, std::string const & name, int n=1) -> MX
    ...
    def add_x(self, *args):
        """
        add_x(DaeBuilder self, std::string const & name, int n=1) -> MX
    ...
    def add_s(self, *args):
        """
        add_s(DaeBuilder self, std::string const & name, int n=1) -> std::pair< casadi::MX,casadi::MX >
    ...
    def add_z(self, *args):
        """
        add_z(DaeBuilder self, std::string const & name, int n=1) -> MX
    ...
    def add_q(self, *args):
        """
        add_q(DaeBuilder self, std::string const & name, int n=1) -> MX
    ...
    def add_d(self, *args):
        """
        add_d(DaeBuilder self, MX new_ddef, std::string const & name) -> MX
    ...
    def add_y(self, *args):
        """
        add_y(DaeBuilder self, MX new_ydef, std::string const & name) -> MX
    ...
    def add_ode(self, *args):
        """
        add_ode(DaeBuilder self, MX new_ode, std::string const & name)
    ...
    def add_dae(self, *args):
        """
        add_dae(DaeBuilder self, MX new_dae, std::string const & name)
    ...
    def add_alg(self, *args):
        """
        add_alg(DaeBuilder self, MX new_alg, std::string const & name)
    ...
    def add_quad(self, *args):
        """
        add_quad(DaeBuilder self, MX new_quad, std::string const & name)
